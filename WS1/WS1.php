...
function GetCountriesIsoOfContinent($Continent){
  ...
  if (strtoupper($Continent)=='AFRICA')
    return json_encode(array('Tunisia'=> 'TN', 'Algeria'=> 'DZ','Libya'=>'LB'));

  elseif (strtoupper($Continent)=='ASIA') 
    return json_encode(array('Qatar'=> 'QA','India'=>'IN','South Korea'=>'KR'));

  elseif (strtoupper($Continent)=='EUROPE') 
    return json_encode(array('France'=> 'FR', 'Spain'=> 'ES','Italy'=>'IT'));
